...
export default class Video extends React.Component<Props, State> implements Playback {
    ...
    static propTypes: {
        ...
        accessibilityRole?: PropTypes.Validator<"none" | "search" | "link" | "button" | "header" | "summary" | "image" | "text" | "keyboardkey" | "adjustable" | "imagebutton" | undefined> | undefined;
        ...
        accessibilityTraits?: PropTypes.Validator<"none" | "key" | "search" | "link" | "selected" | "button" | "header" | "summary" | "image" | "text" | "adjustable" | "disabled" | "plays" | "frequentUpdates" | "startsMedia" | "allowsDirectInteraction" | "pageTurn" | import("react-native").AccessibilityTrait[] | undefined> | undefined;
    ...
    loadAsync: (source: any, initialStatus?: PlaybackStatusToSet, downloadFirst?: boolean) => Promise<PlaybackStatus>;
